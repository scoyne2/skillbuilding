...
ecs-cli compose --project-name airflow-project service up --cluster-config airflow-project --create-log-groups --load-balancer-name airflow-project-load-balancer